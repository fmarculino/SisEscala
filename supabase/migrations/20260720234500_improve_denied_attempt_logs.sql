-- Migration: Improve denied attempt logs
-- Description: Updates public.fn_confirmar_presenca to log closest shift details instead of NULLs when rejection is due to both check-in and check-out already completed.
