-- Migration: Update fn_confirmar_presenca_manual to record scheduled shift hours

-- Drop the old version with public.escala_categoria to prevent overload conflicts
