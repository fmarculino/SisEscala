-- 1. Recreate fn_salvar_saida_bloco with midnight crossing fix for Extra shifts
...
-- 2. Recreate main confirmation function with midnight crossing fix for Extra shifts
...
-- 3. Recreate fn_confirmar_presenca_manual with dynamic extra shifts alignment
...
BEGIN
    ...
    SELECT 
        COALESCE(
            ...
            ELSE NULL END,
            -- Para Extra, busca o término do turno Regular ou Plantão do mesmo dia com tratamento de meia-noite
            (
                SELECT 
                    COALESCE(
                        (
