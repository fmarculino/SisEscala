-- Migration: Split contiguous presence exits
-- Description: Creates fn_salvar_saida_bloco helper function and updates fn_confirmar_presenca to split exit and entry times for contiguous shifts in blocks.
