-- Migration: Fix extra hours presence logical block
-- Description: Updates public.fn_confirmar_presenca to calculate correct start hour for Extra category shifts as the end of the Regular or Plantão shift of the same day.
