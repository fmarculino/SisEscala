-- Migration: Fix Regular and Plantao Shift Start Hours from Jornada Name
-- Description: Updates fn_confirmar_presenca and fn_confirmar_presenca_manual to extract start_hour for Regular category shifts directly from the servant's jornada name (j.nome), resolving issue where 08H AS 18H expected 07:00 and 18H AS 06H expected 19:00. Also preserves dynamic extra hour alignment per AGENTS.md rule.

-- 1. RECREATE fn_confirmar_presenca WITH JORNADA-BASED START HOUR INHERITANCE
