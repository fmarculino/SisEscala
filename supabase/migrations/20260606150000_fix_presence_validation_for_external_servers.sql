-- Migration: Fix presence validation for external servers in scale
-- Description: Updates public.fn_confirmar_presenca to allow coordinators to confirm presence if the server is scaled in their managed units/sectors.
