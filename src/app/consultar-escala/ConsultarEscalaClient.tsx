                    ...
                    <div className="mt-1 flex gap-2">
                      <div className="relative flex-1">
                        ...
                        <input
                          ...
                          className="block w-full pl-10 pr-10 py-2.5 border border-zinc-300 dark:border-zinc-700 rounded-lg bg-zinc-50 dark:bg-zinc-800 text-zinc-900 dark:text-white sm:text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono tracking-[0.5em] text-center"
                          placeholder="••••••"
                        />
                        <button
                          type="button"
