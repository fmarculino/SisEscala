  ...
  return (
    <div className="space-y-4 border-t border-zinc-100 dark:border-zinc-800 pt-6 mt-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor="latitude" className="block text-xs font-medium text-zinc-500">
            Latitude
          </label>
          <input
            type="number"
        ...
        <div>
          <label htmlFor="longitude" className="block text-xs font-medium text-zinc-500">
            Longitude
          </label>
          <input
            type="number"
      ...
      <div>
        <label htmlFor="raio_geofence" className="block text-xs font-medium text-zinc-500">
