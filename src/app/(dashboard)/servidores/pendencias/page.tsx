...
export default async function PendenciasCadastroPage() {
  ...
  // escopada do coordenador — a tela continua visível pra ele (ver sidebar.tsx, 12/08/2026: a
  // correção anterior tinha, por engano, tirado essa tela do menu de RH da Unidade junto das
  // telas de catálogo global, quando só as de catálogo deveriam sair).
  const isCoordEscopo = role === 'coordenador' || role === 'rh_unidade'
