        ...
        {activeTab === 'cadastro' && (
          <div className="space-y-6">
            ...
            {servidor.status === 'Afastado' && (
              <div className="bg-amber-50 border border-amber-200 dark:bg-amber-950/20 dark:border-amber-900/40 p-4 rounded-xl flex gap-3 animate-in fade-in">
                <Info className="h-5 w-5 text-amber-600 dark:text-amber-400 shrink-0 mt-0.5" />
                <div>
                  <p className="text-sm font-bold text-amber-800 dark:text-amber-300">Servidor Afastado</p>
